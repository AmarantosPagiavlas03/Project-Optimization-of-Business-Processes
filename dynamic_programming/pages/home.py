...
from .utilities.forms import (
    task_input_form, shift_input_form, worker_input_form,
    task_template_download, upload_tasks_excel, shift_template_download,
    upload_shifts_excel, task_upload_download_form, shift_upload_download_form
)
...
def show_home():
    ...
    if st.button("Clear All Shifts 124 "):
