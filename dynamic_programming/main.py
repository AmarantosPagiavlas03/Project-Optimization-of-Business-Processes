...
def insert3():
    ...
    c.execute('''
        ...
        VALUES
            ...
            ('task 1', 'Monday', '07:30:00', '07:45:00', '00:45:00', 1),
            ('task 2', 'Monday', '08:00:00', '08:30:00', '00:30:00', 2);
    ...
    c.execute('''
        ...
        VALUES
            ...
            ('06:00:00', '12:00:00', '12:00:00', '0:30:00', 1000, 1, 1, 1, 1, 1, 1, 1),
            ('08:00:00', '14:00:00', '12:00:00', '0:30:00', 1100, 1, 1, 1, 1, 1, 1, 1);
    ''')
    conn.commit()
    conn.close()
