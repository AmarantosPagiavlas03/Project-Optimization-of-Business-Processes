...
def insert():
    ...
    c.execute('''
        ...
        VALUES
            ('task 1', 'Monday', '09:00:00', '23:00:00', 15, 30),
            ('task 2', 'Monday', '09:00:00', '23:00:00', 15, 12),
            ('task 3', 'Monday', '09:00:00', '23:00:00', 45, 9);
    ''')
    conn.commit()
    c.execute('''
        INSERT INTO ShiftsTable3 (
        ...
        VALUES
            ('00:00:00', '12:00:00', '11:30:00', '0:30:00', 1200, 1, 1, 1, 1, 1, 1, 1, 'test1'),
            ('12:00:00', '00:00:00', '13:30:00', '0:30:00', 1300, 1, 1, 1, 1, 1, 0, 0, 'test2');
    ''')
    conn.commit()
    conn.close()
